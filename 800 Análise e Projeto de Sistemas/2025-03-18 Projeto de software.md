...
- Buscar fontes confiáveis
	- Livro, artigo, documentação
- Buscar pelo menos 3 exemplos de ciclos de vida de desenvolvimento de software
	- Classificar o que é Introdução, execução e finalização
- Fazer a análise
